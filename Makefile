...
top_builddir = .
AUTOCONF = ${SHELL} /home/saru/2021/iftop-cygwin/config/missing --run autoconf
AUTOMAKE = ${SHELL} /home/saru/2021/iftop-cygwin/config/missing --run automake-1.5
AUTOHEADER = ${SHELL} /home/saru/2021/iftop-cygwin/config/missing --run autoheader
...
AMTAR = ${SHELL} /home/saru/2021/iftop-cygwin/config/missing --run tar
AWK = gawk
CC = gcc
DEPDIR = .deps
EXEEXT = 
...
am__include = #
am__quote = 
install_sh = /home/saru/2021/iftop-cygwin/config/install-sh
...
# $(DEPDIR)/addr_hash.Po
# $(DEPDIR)/addrs_dlpi.Po
# $(DEPDIR)/addrs_ioctl.Po
# $(DEPDIR)/cfgfile.Po
# $(DEPDIR)/dlcommon.Po
# $(DEPDIR)/edline.Po
# $(DEPDIR)/hash.Po
...
# $(DEPDIR)/options.Po
# $(DEPDIR)/resolver.Po
# $(DEPDIR)/screenfilter.Po
# $(DEPDIR)/serv_hash.Po
# $(DEPDIR)/sorted_list.Po
# $(DEPDIR)/stringmap.Po
# $(DEPDIR)/threadprof.Po
# $(DEPDIR)/ui.Po
# $(DEPDIR)/util.Po
# $(DEPDIR)/vector.Po
